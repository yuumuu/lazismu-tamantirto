...
<body class="bg-zinc-950 flex items-center justify-center min-h-screen p-6 overflow-hidden relative">
    ...
    <div class="absolute inset-0 z-0">
        <div class="absolute top-[-10%] left-[-10%] size-[400px] bg-primary/20 rounded-full blur-[120px] animate-pulse"></div>
        <div class="absolute bottom-[-10%] right-[-10%] size-[400px] bg-primary/10 rounded-full blur-[120px] animate-pulse" style="animation-delay: 2s"></div>
    </div>
    ...
    <div class="max-w-4xl w-full text-center space-y-12 relative z-10">
        ...
        <!-- Headline -->
        <div class="space-y-6">
            <h1 class="text-5xl md:text-8xl font-black text-white tracking-tighter leading-[0.9]">Sesuatu yang<br><span class="text-primary italic">Besar</span> Segera Hadir.</h1>
            <p class="text-lg md:text-2xl text-zinc-400 font-medium leading-relaxed max-w-2xl mx-auto">
                Kami sedang menyiapkan pengalaman baru dalam berdonasi yang lebih mudah, transparan, dan berdampak bagi sesama.
            </p>
        </div>
        ...
        <div class="max-w-md mx-auto space-y-4">
            <div class="relative group">
                <input type="email" placeholder="Masukkan email Anda..." class="w-full h-16 bg-white/5 border border-white/10 rounded-2xl px-6 text-white focus:outline-none focus:border-primary/50 transition-all">
                <button class="absolute right-2 top-2 h-12 px-6 bg-primary text-white font-black text-xs uppercase tracking-widest rounded-xl hover:scale-105 active:scale-95 transition-all">
                    Ingatkan Saya
                </button>
            </div>
