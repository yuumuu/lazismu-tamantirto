    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div class="space-y-2">
             <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl font-black tracking-tight text-zinc-900 dark:text-white">{{ __('Hero Banners') }}</h1>
            </div>
            <p class="text-zinc-500 dark:text-zinc-400 text-sm max-w-lg leading-relaxed border-l pl-4 border-zinc-200 dark:border-zinc-800">
                {{ __('Kelola banner yang akan tampil di halaman utama website publik.') }}
            </p>
        </div>
