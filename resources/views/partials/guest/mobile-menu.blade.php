...
<div x-cloak x-show="open" 
    ...
    <!-- Backdrop -->
    <div class="fixed inset-0 bg-zinc-950/60 backdrop-blur-sm" @click="open = false" aria-hidden="true"></div>

    <!-- Drawer Content -->
    <div class="fixed inset-y-0 left-0 w-[80%] max-w-sm bg-white dark:bg-zinc-900 shadow-2xl flex flex-col">
        <div class="p-6 flex items-center justify-between border-b border-zinc-100 dark:border-white/5">
            <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col leading-tight">
                    <span class="text-zinc-900 dark:text-white font-black text-lg tracking-tighter uppercase">Lazismu</span>
                    <span class="text-primary font-bold text-[9px] tracking-[0.2em] uppercase">Tamantirto</span>
                </div>
            </div>
