            ...
            <div class="space-y-2">
                <div class="flex justify-between items-end">
                    ...
                    <div class="flex flex-col items-end">
                        ...
                        <span class="text-sm font-bold text-zinc-900 dark:text-white">{{ format_rupiah_short($campaign->target_amount) }}</span>
                    </div>
                </div>
                <div class="relative w-full h-3 bg-zinc-100 dark:bg-white/5 rounded-full overflow-hidden">
                    <div class="absolute top-0 left-0 h-full bg-primary rounded-full transition-all duration-1000 group-hover:bg-primary-light" style="width: {{ $campaign->progress_percentage }}%">
