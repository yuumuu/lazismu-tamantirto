        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
            ...
            <div class="space-y-6 lg:col-span-2">
                <a href="{{ guest_route('guest.home') }}" class="flex items-center gap-3">
                    <div
                        class="flex aspect-square size-10 items-center justify-center rounded-xl bg-transparent text-white shadow-none">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ guest_route('guest.campaigns.index') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Program
                            Donasi</a></li>
                    <li><a href="{{ guest_route('guest.posts.index') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Berita
                            & Artikel</a></li>
                    <li><a href="{{ guest_route('guest.about') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Tentang
                            Kami</a></li>
                    <li><a href="{{ guest_route('guest.contact') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Hubungi
                            Kami</a></li>
                </ul>
            </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        @foreach ($pages as $page)
                            <li><a href="{{ guest_route('guest.page', $page->slug) }}"
                                    class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">{{ $page->title }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ guest_route('guest.donate.form') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Zakat
                            Online</a></li>
                    <li><a href="{{ guest_route('guest.donate.form') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Infaq
                            & Sedekah</a></li>
                    <li><a href="{{ guest_route('guest.calculator') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Kalkulator
                            Zakat</a></li>
                    <li><a href="{{ guest_route('guest.reports') }}"
                            class="text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors text-sm">Laporan
                            Keuangan</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span
                            class="text-zinc-500 dark:text-zinc-400 text-sm italic">{{ setting('contact_address', 'Jl. Brawijaya, Tamantirto, Kasihan, Bantul, DIY') }}</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <flux:icon.phone class="size-5 text-primary shrink-0" />
                        <span
                            class="text-zinc-500 dark:text-zinc-400 text-sm">{{ setting('contact_phone', '0812-3456-7890') }}</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <flux:icon.envelope class="size-5 text-primary shrink-0" />
                        <span
                            class="text-zinc-500 dark:text-zinc-400 text-sm">{{ setting('contact_email', 'lazismu@umy.ac.id') }}</span>
                    </li>
                </ul>
            </div>
        </div>
